...
public class ReserModifyController implements Controller {
	...
	public String handleRequest(HttpServletRequest request,
		...
		String p_outprcie="";
			...
			if(p_pic == null || p_pic.equals("")){
				...
				p_pic=mr.getParameter("p_pic_db");
			}else{
			...
			p_outprcie = mr.getParameter("p_outprice");
			System.out.println(p_outprcie);
			order_no = mr.getParameter("order_no");
			...
			Reser reser = new Reser(p_name, 
														...
														Integer.parseInt(p_outprcie));
			int row = ReserManager.getInstance().updateReser(Integer.parseInt(order_no), reser);
			System.out.println(reser.getP_outprice()+"++");
